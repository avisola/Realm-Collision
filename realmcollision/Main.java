...
public class Main {
    ...
    public static void showMainMenu() {
        ...
        Color accentColor = new Color(0, 150, 255); // Blue accent
    ...
    public static void showCharacterSelection() {
        ...
        // Title
        JLabel titleLabel = new JLabel("CHOOSE YOUR CHARACTERS", SwingConstants.CENTER);
        ...
        startButton.addActionListener(e -> {
            ...
            if (p1Choice.equals(p2Choice)) {
                JOptionPane.showMessageDialog(selectionFrame, "Cannot select the same character for both players!");
                return;
            }
    ...
    private static void startGame(String p1Choice, String p2Choice) {
        // Extract character codes (AM, DG, etc.)
    ...
    public static void showAcquaintancesMenu() {
        JFrame descFrame = new JFrame("Character Descriptions");
        ...
        // Add character description tabs
    ...
    // Character lore (unchanged)
    private static String getArcMageLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "Their war, the Schism of Genesis, shattered the Source into the multiverse.\n" +
                "The Radiant Sovereign won, casting The Umbral Primordial into the abyssal void—the Hell Dimension.\n" +
                "But the Primordial was not destroyed. Its corrupting influence, known as The Blight, began to seep back into creation.\n" +
                "Its goal: to consume all realities and return everything to the silent unity of non-existence.\n\n" +

                "PART I: The Birth of the Phoenix Princess \n\n" +
    ...
    private static String getDemiGodLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                ...
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "Their war, the Schism of Genesis, shattered the Source into the multiverse.\n" +
                "The Radiant Sovereign won, casting The Umbral Primordial into the abyssal void.\n" +
                "But the Primordial's corrupting influence, The Blight, seeped into creation, seeking to exploit any weakness.\n\n" +
    ...
    private static String getTricksterLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "Their war, the Schism of Genesis, shattered the Source into the multiverse, including the river of time, Veylharra.\n" +
                "The Umbral Primordial, cast into the void, learned that to corrupt reality, it must first corrupt time itself.\n\n" +

                "PART I: The Apostle of Veylharra\n\n" +
    ...
    private static String getDeadeyeLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign and The Umbral Primordial.\n" +
                "The Umbral Primordial, cast into the void, understood that to consume all reality, it must operate across all timelines simultaneously, creating a collapse so absolute that not even time could escape.\n\n" +

                "PART I: The Finest Gunslayer of the Neo-Frontier\n\n" +
    ...
    private static String getTerminatorLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "The Umbral Primordial understood that to defeat a universe of magic and gods, it must create a weapon they could not comprehend: a perfect, logical, and unstoppable physical calamity.\n\n" +

                "PART I: The Birth of the Perfect Weapon\n\n" +
    ...
    private static String getKnightLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "The Radiant Sovereign created the Crystal Order and its knights to be the first and last line of defense against the Blight's inevitable return.\n\n" +

                "PART I: Chosen by the Radiant Sovereign\n\n" +
    ...
    private static String getValkyrieLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "The Valkyries were created as celestial arbiters, but the Primordial sought to corrupt them from within by exploiting their pride and prejudice.\n\n" +

                "PART I: The Witch’s Daughter\n\n" +
    ...
    private static String getWandererLore() {
        return "PROLOGUE: The Primordial Schism & The Umbral Primordial\n\n" +
                "In the beginning, the cosmos was a singular consciousness known as the Source.\n" +
                "From it, two forces emerged: The Radiant Sovereign (Order, Light) and The Umbral Primordial (Chaos, Shadow).\n" +
                "Shinmu is a natural phenomenon—a living embodiment of the conflict itself, born from the echoes of the Schism. His endless battle is a reflection of the cosmos's fundamental state of war.\n\n" +

                "PART I: Shinmu, Sword God of Eternity\n\n" +
